...
en_strings = {
    ...
    "sidebar_nav_password": "🔑 Change Password",
    # ui/password.py
    "password_change_title": "🔑 Change Password",
    "password_change_description": "Update your account password. You'll need to enter your current password and choose a new one.",
    "password_change_current_password": "Current password",
    "password_change_current_password_help": "Enter your current password to verify your identity.",
    "password_change_new_password": "New password",
    "password_change_new_password_help": "Enter your new password (minimum 6 characters).",
    "password_change_confirm_password": "Confirm new password",
    "password_change_confirm_password_help": "Re-enter your new password to confirm.",
    "password_change_submit_button": "💾 Update Password",
    "password_change_success": "✅ Password updated successfully!",
    "password_change_error_current_required": "Please enter your current password.",
    "password_change_error_new_required": "Please enter a new password.",
    "password_change_error_min_length": "New password must be at least 6 characters long.",
    "password_change_error_mismatch": "New password and confirmation do not match.",
    "password_change_error_same_password": "New password must be different from current password.",
    "password_change_error_incorrect": "Current password is incorrect.",
    "password_change_error_database": "Database error. Please try again later.",
    "password_change_error_user_not_found": "User account not found.",
    "password_change_error_generic": "Failed to update password. Please try again.",
...
de_strings = {
    ...
    "sidebar_nav_chat": "💬 Chat",
    "sidebar_nav_admin": "🛡️ Admin",
    "sidebar_nav_password": "🔑 Passwort ändern",
    # ui/password.py
    "password_change_title": "🔑 Passwort ändern",
    "password_change_description": "Aktualisieren Sie Ihr Kontopasswort. Sie müssen Ihr aktuelles Passwort eingeben und ein neues wählen.",
    "password_change_current_password": "Aktuelles Passwort",
    "password_change_current_password_help": "Geben Sie Ihr aktuelles Passwort ein, um Ihre Identität zu bestätigen.",
    "password_change_new_password": "Neues Passwort",
    "password_change_new_password_help": "Geben Sie Ihr neues Passwort ein (mindestens 6 Zeichen).",
    "password_change_confirm_password": "Neues Passwort bestätigen",
    "password_change_confirm_password_help": "Geben Sie Ihr neues Passwort erneut ein, um es zu bestätigen.",
    "password_change_submit_button": "💾 Passwort aktualisieren",
    "password_change_success": "✅ Passwort erfolgreich aktualisiert!",
    "password_change_error_current_required": "Bitte geben Sie Ihr aktuelles Passwort ein.",
    "password_change_error_new_required": "Bitte geben Sie ein neues Passwort ein.",
    "password_change_error_min_length": "Das neue Passwort muss mindestens 6 Zeichen lang sein.",
    "password_change_error_mismatch": "Neues Passwort und Bestätigung stimmen nicht überein.",
    "password_change_error_same_password": "Das neue Passwort muss sich vom aktuellen Passwort unterscheiden.",
    "password_change_error_incorrect": "Das aktuelle Passwort ist falsch.",
    "password_change_error_database": "Datenbankfehler. Bitte versuchen Sie es später erneut.",
    "password_change_error_user_not_found": "Benutzerkonto nicht gefunden.",
    "password_change_error_generic": "Passwort konnte nicht aktualisiert werden. Bitte versuchen Sie es erneut.",
    # ui/admin.py (Sidebar Nav)
